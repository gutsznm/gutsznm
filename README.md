...
<table>
  <tr>
    <td width="50%">
      <a href="https://github.com/denisahendra/project-alpha">
        <strong>Project Alpha</strong>
      </a>
      <br />
      <span style="color: #4A5568;">Real-time analytics dashboard for e-commerce platforms</span>
      <br />
      <code>React</code> <code>Node.js</code> <code>WebSocket</code> <code>PostgreSQL</code>
    </td>
    <td width="50%">
      <a href="https://github.com/denisahendra/project-beta">
        <strong>Project Beta</strong>
      </a>
      <br />
      <span style="color: #4A5568;">Microservices orchestration with service mesh integration</span>
      <br />
      <code>Golang</code> <code>gRPC</code> <code>Kubernetes</code> <code>Istio</code>
    </td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/denisahendra/project-gamma">
        <strong>Project Gamma</strong>
      </a>
      <br />
      <span style="color: #4A5568;">AI-powered code review assistant using LLMs</span>
      <br />
      <code>Python</code> <code>FastAPI</code> <code>PyTorch</code> <code>Docker</code>
    </td>
    <td>
      <a href="https://github.com/denisahendra/project-delta">
        <strong>Project Delta</strong>
      </a>
      <br />
      <span style="color: #4A5568;">CLI tool for developer productivity automation</span>
      <br />
      <code>TypeScript</code> <code>Node.js</code> <code>Commander.js</code>
    </td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/denisahendra/project-epsilon">
        <strong>Project Epsilon</strong>
      </a>
      <br />
      <span style="color: #4A5568;">Event-driven payment processing system</span>
      <br />
      <code>Java</code> <code>Spring Boot</code> <code>Kafka</code> <code>Redis</code>
    </td>
    <td>
      <a href="https://github.com/denisahendra/project-zeta">
        <strong>Project Zeta</strong>
      </a>
      <br />
      <span style="color: #4A5568;">Infrastructure as Code templates for AWS</span>
      <br />
...
<table>
  <tr>
    <td width="25%"><strong>2022 - Present</strong></td>
    <td>
      <strong>Senior Software Engineer</strong> · TechCorp Inc.
      <br />
      <span style="color: #4A5568;">Leading backend team for a SaaS product serving 10,000+ enterprise customers. Designed microservices architecture and implemented CI/CD pipelines.</span>
    </td>
  </tr>
  <tr>
    <td><strong>2020 - 2022</strong></td>
    <td>
      <strong>Software Engineer</strong> · FinTech Solutions
      <br />
      <span style="color: #4A5568;">Built payment processing APIs handling $50M+ monthly transactions. Improved system latency by 40% through query optimization.</span>
    </td>
  </tr>
  <tr>
    <td><strong>2018 - 2020</strong></td>
    <td>
      <strong>Junior Developer</strong> · Startup Labs
      <br />
      <span style="color: #4A5568;">Developed full-stack features for a property management platform. Introduced testing frameworks and code review culture.</span>
    </td>
  </tr>
</table>
...
<div align="center">
  <table>
    <tr>
      <td align="center">
        <a href="https://linkedin.com/in/denisahendra">
          <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" />
        </a>
      </td>
      <td align="center">
        <a href="https://twitter.com/denisahendra">
          <img src="https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white" />
        </a>
      </td>
      <td align="center">
        <a href="https://denisahendra.dev">
